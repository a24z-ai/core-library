...
describe('Palace URI Utilities', () => {
  describe('parsePalaceUri', () => {
    ...
    test('should parse URI with query parameters', () => {
      const uri = 'palace://github.com/user/repo/drawing/draw-1?branch=main&version=2';
      const parsed = parsePalaceUri(uri);
  ...
  describe('buildPalaceUri', () => {
    ...
    test('should build URI with query parameters', () => {
      ...
      expect(uri).toBe('palace://github.com/user/repo/view/view-1?branch=develop&tag=v1.0');
    });
  ...
  describe('buildGitHubPalaceUri', () => {
    ...
    test('should build GitHub URI with branch', () => {
      const uri = buildGitHubPalaceUri('user', 'repo', 'drawing', 'draw-1', 'develop');
      expect(uri).toBe('palace://github.com/user/repo/drawing/draw-1?branch=develop');
    });
  });
  ...
  describe('isPalaceUri', () => {
    test('should identify palace URIs', () => {
      ...
      expect(isPalaceUri('palace://github.com/user/repo/view/view-1')).toBe(true);
  ...
  describe('extractRepositoryFromUri', () => {
    test('should extract GitHub repository info', () => {
      const parsed = parsePalaceUri('palace://github.com/owner/repo/room/room-1?branch=main');
    ...
    test('should handle other repository types', () => {
      const parsed = parsePalaceUri('palace://gitlab.com/user/repo/drawing/draw-1');
      const info = extractRepositoryFromUri(parsed!);
